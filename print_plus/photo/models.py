...
class Documents(models.Model):
    ...
    document = models.CharField(
        max_length=100, blank=True, db_index=True, verbose_name="Документ"
    )
...
class Orders(models.Model):
    ...
    paper_type = models.CharField(
        max_length=100, db_index=True, verbose_name="Тип бумаги"
    )
    format = models.CharField(max_length=100, db_index=True, verbose_name="Формат")
    document_type = models.CharField(
        max_length=100, blank=True, db_index=True, verbose_name="Тип документа"
    )
    instance_count = models.CharField(
        max_length=100, db_index=True, verbose_name="Количество экземпляров"
    )
    page_count = models.CharField(
        max_length=100, db_index=True, verbose_name="Количество страниц"
    )
    price = models.CharField(max_length=100, db_index=True, verbose_name="Цена")
